...
st.markdown("""\n I apply K-Means clustering to identify structual changes in UK power generation mix. <br>
            For detailed analysis, please refer to [GitHub](https://github.com/chihyuehhuang/UK_generation_mix_change/tree/main/analytics). <br>
